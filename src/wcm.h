...
typedef void(*tablet_motion_func)(double x, double y, double p, double r, double tx, double ty, double altitude, double azimuth);

//	possible values: x y pressure rotation tiltx tilty altitude azimuth?
typedef void(*tablet_down_func)(double x, double y, double p, double r, double tx, double ty, double altitude, double azimuth);
typedef void(*tablet_up_func)(double x, double y, double p, double r, double tx, double ty, double altitude, double azimuth);
typedef void(*tablet_drag_func)(double x, double y, double p, double r, double tx, double ty, double altitude, double azimuth);
