...
void process_event(NSEvent* theEvent)
{
	...
	if (
	    eventType == NSMouseMoved || eventType == NSTabletPoint || eventType == NSLeftMouseDragged || eventType == NSRightMouseDragged || eventType == NSOtherMouseDragged

	    || eventType == NSLeftMouseDown || eventType == NSRightMouseDown || eventType == NSOtherMouseDown

	    || eventType == NSLeftMouseUp || eventType == NSRightMouseUp || eventType == NSOtherMouseUp)
	{
		isMouseEvent = YES;
	}
...
void wcm_tablet_cocoa_init()
{
	...
	NSEventMask observedTypes =
	    ...
	    | NSMouseMovedMask | NSLeftMouseDraggedMask | NSRightMouseDraggedMask | NSOtherMouseDraggedMask

	    | NSLeftMouseDownMask | NSRightMouseDownMask | NSOtherMouseDownMask

	    | NSLeftMouseUpMask | NSRightMouseUpMask | NSOtherMouseUpMask
	    //	the future?
	    | NSEventMaskTabletPoint | NSEventMaskTabletProximity | NSEventMaskLeftMouseDown | NSEventMaskLeftMouseDragged | NSEventMaskLeftMouseUp | NSEventMaskRightMouseDown | NSEventMaskRightMouseDragged | NSEventMaskRightMouseDown | NSEventMaskOtherMouseDown | NSEventMaskOtherMouseDragged | NSEventMaskOtherMouseUp;
