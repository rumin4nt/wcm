...
{
	printf("got rich motion?%f %f %d %f %f %f %f %f %f \n", x, y, b, p, r, tx, ty);
}
...
{
	printf("got rich drag? %f %f %d %f %f %f %f %f %f \n", x, y, b,p, r, tx, ty);
...
{
	printf("got rich up? %f %f %d %f %f %f %f %f %f \n", x, y, b,p, r, tx, ty);
	display_radius = p * 32 * dpi;
